const FeaturesPage = () => {
  return (
    <div className="py-16 max-w-6xl mx-auto px-4">
      ...
      <p className="text-xl text-center mb-12" style={{color: 'var(--text-white-secondary)'}}>
      ...
      <section className="mb-16">
        ...
        <div className="rounded-lg p-6 mb-8" style={{backgroundColor: 'var(--masters-green-medium)'}}>
          <p className="mb-4" style={{color: 'var(--text-white-secondary)'}}>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="space-y-1 text-sm" style={{color: 'var(--text-white-secondary)'}}>
      ...
      <section className="mb-16">
        ...
        <div className="rounded-lg p-6" style={{backgroundColor: 'var(--masters-green-medium)'}}>
          ...
          <div className="mt-6 p-4 rounded" style={{backgroundColor: 'var(--masters-green-dark)'}}>
            ...
            <div className="grid md:grid-cols-4 gap-4 text-sm" style={{color: 'var(--text-white-secondary)'}}>
              <div>• Total Makes</div>
              <div>• Best Streak</div>
